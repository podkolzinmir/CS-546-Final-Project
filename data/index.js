...
async function main(){
  try{
    ...
    const updatedURLs1 = await usersData.addUrls(user1._id.toString(), ["https://techcrunch.com/2020/10/27/wyze-launches-version-3-of-its-20-security-camera/"]);
    console.log(updatedURLs1);*/
    const updatedURLs2 = await keywordsData.addUrls(keyword1._id.toString(), ["https://techcrunch.com/2020/10/27/wyze-launches-version-3-of-its-20-security-camera/"]);
