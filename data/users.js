...
async function create(name, email, interests, urls, sec_question, sec_answer, password){
  if(name == null || email == null || interests == null || urls == null || sec_question == null || sec_answer == null || password == null){
